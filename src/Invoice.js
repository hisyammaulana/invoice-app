...
export default function Invoice() {
    ...
    const getInvoice = async () => {
        const data = await axios('http://localhost/smart_school/api/data/spp/transaksi_konfirmasi/kode/TRX-1209198-1627285545/tagihan').then(
            (res) => res.data.data
        )
        console.log(data);
        setInvoice(data);
                    ...
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <div className="lg:w-full w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            ...
                            {/* <div className="flex border-t border-gray-200 py-2">
                                <span className="text-gray-500">Spp Bulan 1</span>
                            ...
                            <div className="flex">
                                ...
                                <button className="flex ml-auto text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-800 rounded">Bayar</button>
                            </div>
                        </div>
                    </div>
                </div>
